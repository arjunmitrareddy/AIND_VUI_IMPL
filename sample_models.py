...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for r_layer in range(recur_layers):
        rnn = GRU(units=units, activation='relu', return_sequences=True, implementation=2, name='rnn' + str(r_layer))(temp)
        temp = BatchNormalization(name='bn_rnn' + str(r_layer))(rnn)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(GRU(units=units,activation='relu', return_sequences=True, implementation=2,name='bidir_rnn'))(input_data)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    #conv_1d_2 = Conv1D(filters*2, kernel_size, strides=conv_stride, padding=conv_border_mode, activation='relu', name='conv_1d_2')(conv_1d)
